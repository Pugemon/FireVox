...
#ifndef FIREVOXLIB_TYPES_HPP
#define FIREVOXLIB_TYPES_HPP
...
#ifndef FV_PACKED
#define FV_PACKED     __attribute__((packed))
#endif

/// Marks a function as not returning, for the purposes of compiler optimization.
#ifndef FV_NORETURN
#define FV_NORETURN   __attribute__((noreturn))
#endif

/// Performs a dummy operation on the specified argument in order to silence compiler warnings about unused arguments.
#ifndef FV_IGNORE_ARG
#define FV_IGNORE_ARG(x) (void)(x)
#endif

/// Flags a function as deprecated.
#ifndef FV_DEPRECATED
#ifndef FIREVOX_NO_DEPRECATION
#define FV_DEPRECATED __attribute__ ((deprecated))
#else
#define FV_DEPRECATED
#endif
#endif

/// Flags a function as (always) inline.
#define FV_INLINE __attribute__((always_inline)) static inline

/// Flags a function as constexpr in C++14 and above; or as (always) inline otherwise.
#if __cplusplus >= 201402L
#define FV_CONSTEXPR FV_INLINE constexpr
#else
#define FV_CONSTEXPR FV_INLINE
#endif

/// Invalid handle.
#define INVALID_HANDLE ((Handle) 0)

#endif //FIREVOXLIB_TYPES_HPP